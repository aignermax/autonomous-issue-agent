...
# Appended to every PR the agent opens (any repo) so reviewers discover how
# to steer it without hunting for external docs. Collapsed by default.
_AGENT_FOOTER = """
...
class GitHubClient:
    ...
    def authenticated_login(self) -> str:
        """Login of the token's user (assignable) — NOT the repo owner, which
        may be an org that GitHub silently refuses to assign."""
    ...
    def create_pull_request(self, branch: str, issue, body_suffix: str = "", summary: str = "", base: str = "main", previous_pr_number: int = None, walkthrough: str = "") -> str:
        ...
        Args:
            ...
            walkthrough: Optional visual-walkthrough markdown (screenshots) to
        ...
        body_parts.append(_AGENT_FOOTER)
